...
"""Evaluation harness for LLaDA decoding."""
import accelerate
import torch
import re
...
class LLaDAEvalHarness(LM):
    ...
    def generate_until(self, requests):
        ...
        if self.save_dir is not None:
            ...
            save_path = os.path.join(self.save_dir, f'rank_{rank}{suffix}.jsonl')
            ...
            if os.path.exists(save_path):
                ...
                with open(save_path, 'r', encoding='utf-8') as f:
                    for line in f:
                        ...
                        output.append(data['answer'] if isinstance(data, dict) else data)
            ...
            if self.save_dir is not None:
                with open(save_path, 'a', encoding='utf-8') as f:
                    for ans in batched_generated_answer:
                        rec = {'answer': ans, 'nfe': nfe, 'block_length': self.block_length,
